...
jQuery(function (a) {
    ...
    json_visible
      ? (a("#all_panels")
        ...
        table_visible && tree_visible
          ...
          : table_visible && !tree_visible
          ? a("#xxa").split().position(xxa_pnl_size)
          : table_visible ||
            tree_visible ||
    ...
    json_visible
      ? ((json_pnl_size = a("#json_pnl").width()),
        ...
        table_visible && tree_visible
          ...
          : !table_visible && tree_visible && a("#xxa").split().position(0))
      : a("#all_panels").split().position(0);
  };
  ...
  a("#jsonViewMenu").click(function () {
    if (table_visible || tree_visible)
      a("#jsonLi").toggleClass("active "), (json_visible = !json_visible), e();
  });
  ...
  a("#treeViewMenu").click(function () {
    if (json_visible || table_visible)
      a("#treeLi").toggleClass("active "), (tree_visible = !tree_visible), e();
  });
    ...
    "object" != typeof a[c] || isArray(a[c])
      ? "object" == typeof a[c] && isArray(a[c])
        ...
        : ((d = e.insertRow(-1)),
          ...
          (d = d.insertCell(-1)),
          (d.innerHTML =
            "<div class='td_row_even'>" + encodeText(a[c]) + "</div>"))
      : ((d = e.insertRow(-1)),
        (b = d.insertCell(-1)),
        (b.colSpan = 2),
        (b.innerHTML =
          ...
          (b = d.insertCell(c)),
            ...
            (l =
              c == h
                ...
                : " "),
            (b.innerHTML =
              "<div class='" + td_class + "'>" + encodeText(l) + "</div>");
      else
        for (h = m.empty, c = 0; c < n; c++)
          (b = d.insertCell(c)),
            (l = c == h ? a[f] : " "),
